package com.laby.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableRespVO {
    ...
    @Schema(description = "表名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "laby")
    private String tableName;

    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "Laby")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "Laby")
