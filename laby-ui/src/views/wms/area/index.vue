<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="库区类型" align="center" prop="areaType" width="120px">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.WMS_WAREHOUSE_AREA_TYPE" :value="scope.row.areaType" />
        </template>
      </el-table-column>
      <el-table-column label="楼层" align="center" prop="floor" width="80px" />
      <el-table-column label="面积(㎡)" align="center" prop="areaSize" width="120px" />
