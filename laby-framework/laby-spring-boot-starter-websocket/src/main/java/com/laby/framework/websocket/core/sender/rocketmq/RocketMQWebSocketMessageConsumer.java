package com.laby.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${laby.websocket.sender-rocketmq.topic}",
        consumerGroup = "${laby.websocket.sender-rocketmq.consumer-group}",
