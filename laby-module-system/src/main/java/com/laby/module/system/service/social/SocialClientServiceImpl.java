package com.laby.module.system.service.social;
...
import com.laby.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.laby.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.laby.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.laby.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.laby.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.laby.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.laby.module.system.dal.dataobject.social.SocialClientDO;
import com.laby.module.system.dal.mysql.social.SocialClientMapper;
import com.laby.module.system.dal.redis.RedisKeyConstants;
import com.laby.module.system.enums.social.SocialTypeEnum;
import com.laby.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.laby.framework.common.util.collection.MapUtils.findAndThen;
import static com.laby.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.laby.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.laby.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${laby.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${laby.wxa-subscribe-message.miniprogram-state:formal}")
