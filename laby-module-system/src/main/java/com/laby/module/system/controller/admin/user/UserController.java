package com.laby.module.system.controller.admin.user;
...
import com.laby.module.system.controller.admin.user.vo.user.*;
import com.laby.module.system.convert.user.UserConvert;
import com.laby.module.system.dal.dataobject.dept.DeptDO;
import com.laby.module.system.dal.dataobject.user.AdminUserDO;
import com.laby.module.system.enums.common.SexEnum;
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@iocoder.cn").mobile("15601691300")
                        .nickname("Laby").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
